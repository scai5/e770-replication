...
# Replicating Table 2: Effect of presence of EITC laws
...
tab_2 <- tab_2 %>% 
  tab_header(
    title = md("**Table 2: Effects of Presence of EITC Laws, Low Educated Mothers**")
  ) %>%
  tab_source_note(
...
gtsave(tab_2, "./results/table2.html")
gtsave(tab_2, "./results/table2.docx")
