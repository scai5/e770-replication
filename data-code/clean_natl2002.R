...
# Importing and cleaning 2002 birth certificate data 
...
natl2002 <- read.delim("./data/raw/Natl2002.dat", header=FALSE)
colnames(natl2002) <- c("raw")
...
write_csv(natl2002, "./data/generated/clean_2002.csv")
rm(list = ls())